...
homepage](/images/elevance.png "Screenshot of Elevance Health's 2022 annual report
homepage")

The brief was straightforward, however the timeline was tight and I was the on;y
...
and compile the PDF on a separate server. I revamped this to to build the PDF's
