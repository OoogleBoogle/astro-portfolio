...
<ProjectHeading text="Google Ads" destination="https://ads.google.com" />
...
My team was tasked with creating a UI Library that could be easily
shared around, but without the use of <em>any</em>  external frameworks.
